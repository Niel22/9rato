            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
                            <form class="row g-4" wire:submit="login">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-animation w-100 justify-content-center" type="submit">
                                        ...
                                        <span wire:loading>Checking Credentials</span>
                                    </button>
                                </div>
                            </form>
                        </div>
                            ...
                            <ul>
                                <li>
                                    <a href="https://www.google.com/" class="btn google-button w-100">
                                        <img src="../assets/images/inner-page/google.png" class="blur-up lazyloaded" alt=""> Log In with Google
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.facebook.com/" class="btn google-button w-100">
                                        <img src="../assets/images/inner-page/facebook.png" class="blur-up lazyloaded" alt=""> Log In with Facebook
                                    </a>
                                </li>
                            </ul>
                        </div>
