        ...
        <div class="title">
            ...
            <span class="title-leaf">
                <svg class="icon-width">
                    <use xlink:href="assets/svg/leafs.svg#leaf"></use>
                </svg>
            </span>
        </div>
        <div class="row g-4">
                ...
                <div class="product-theme-box">
                    <div class="img-box ratio_50">
                        <a href="{{ route('product.buy') }}" style="height: 200px">
                            <img src="{{ asset('assets/images/products/p1.jpg') }}" class="bg-img">
                        </a>
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-5 col-6">
                <div class="product-theme-box">
                    <div class="img-box ratio_50">
                        <a href="{{ route('product.buy') }}" style="height: 200px">
                            <img src="{{ asset('assets/images/products/p2.jpg') }}" class="bg-img">
                        </a>
                        <a href="#!" class="heart-icon">
                            <i data-feather="heart"></i>
                        </a>
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-5 col-6">
                <div class="product-theme-box">
                    <div class="img-box ratio_50">
                        <a href="{{ route('product.buy') }}" style="height: 200px">
                            <img src="{{ asset('assets/images/products/p3.jpg') }}" class="bg-img">
                        </a>
                        <a href="#!" class="heart-icon">
                            <i data-feather="heart"></i>
                        </a>
