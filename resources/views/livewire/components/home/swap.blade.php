<section class="product-section">
        <div class="container-fluid-lg">
                ...
                <div class="col-xxl-3 col-lg-4 col-sm-5 col-6">
                    <div class="product-theme-box">
                        <div class="img-box ratio_50">
                            <a href="{{ route('product.swap') }}" style="height: 200px">
                        ...
                        <div class="content-box">
                            ...
                            <div class="bottom-content">
                                ...
                                <div class="btn-grp">
                                    <a class="btn" href="{{ route('product.swap') }}">Swap</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-4 p-4 d-flex justify-content-center align-items-center">
                <div class="col-xxl-3 col-lg-4 col-sm-5 col-6">
                    <a href="" class="btn btn-sm bg-success btn-dark text-white">All Listed Swaps</a>
                </div>
            </div>
        </div>
    </section>